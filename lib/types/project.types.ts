...
import { MemberProfile } from './common.types';

import { ProjectStatus, InterviewStatus, TechStackStructure, TeamMember, RoleSuggestion } from './common.types';

// TeamMember는 common.types에서 import됨
...
// RoleSuggestion, TechStackStructure는 common.types에서 import됨
...
/**
 * 팀원 프로필 (개별 면담에서 수집) - interview.types.ts로 이동됨
 * @deprecated interview.types.ts의 MemberProfile 사용
 */
